...
public class StringClassMethods {
	...
	public static void main(String[] args) {
		...
		/*
		 * Returns the char value at the specifies index.An index ranges from 0to
		 ...
		 * value of each charachter in the strings. the character sequence represented by
		 ...
		 * String object lexicographically precedes the argument string the result is
		 * apositive integer if this String object lexicographically follows the argument
